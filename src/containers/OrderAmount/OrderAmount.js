    ...
    <Box className='order-amount'>
      <div className='order-amount-wrap'>
        ...
        <div className='order-amount-detail'>
          <div>
            <p className='order-amount-text'>Товары({data && data.length})</p>
            <p className='order-amount-text amount'>{data && data.map(el => el.count * el.price).reduce((a,b) => a+b)}c</p>
          </div>
          <div>
      ...
      <div className='order-amount-total-wrap'>
        ...
        <p className='total-amount'>{data && data.map(el => el.count * el.price).reduce((a,b) => a+b)}с</p>
      </div>
